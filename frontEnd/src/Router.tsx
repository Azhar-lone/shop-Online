...
let Router = createBrowserRouter(
    createRoutesFromElements(
        <Route errorElement={<ErrorPage />}>
            ...
            <Route path="/login" element={<NoLoginProtected><Login /></NoLoginProtected>} />
            <Route path="/signup" element={<NoLoginProtected><Signup /></NoLoginProtected>} />
            <Route path="/forgot-password" element={<NoLoginProtected><ForgotPassword /></NoLoginProtected>} />
            <Route path="/verify-otp" element={<NoLoginProtected><VerifyCode /></NoLoginProtected>} />
