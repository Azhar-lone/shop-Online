...
const Product: React.FC<Type> = (
    ...
    return (
        <div
            className="lg:h-[60vh] h-96 mt-2 border rounded-2xl  shadow-2xl bg-card  sm:w-[48%] md:w-[31%] lg:w-[23%] w-[47%] hover:scale-105 hover:cursor-pointer delay-75 transition-all animate-fade-in"
        >
