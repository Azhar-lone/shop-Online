...
const UploadProduct = () => {
    ...
    let [categories, setCategories] = useState<Array<ObjectString>>([{ value: "test" }])
    ...
    async function getCategories() {
        try {
            ...
            let res = await fetch(import.meta.env.VITE_BackendUrl + baseUrl + "/general/categories")
    ...
    async function handleSubmit(values: z.infer<typeof productSchema>) {
        try {
            ...
            const baseUrl = import.meta.env.VITE_BaseUrl
            let response = await fetch(import.meta.env.VITE_BackendUrl + baseUrl + '/users/UploadProduct', {
                method: 'POST',
                headers: {
    ...
    return (
        ...
        <Container >
            ...
            <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight text-center">Upload Product</h3>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea placeholder="Products discription" {...field} draggable />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
...
const productSchema = z.object({
    ...
    discription: z.string().min(50, { message: "should be atleast 50 charactors long" }).max(450, { message: "should be atleast 50 charactors long" }),
...
const ImagePicker = () => {
    ...
    return <div className='border border-input'>
